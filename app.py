...
def ask():
    ...
    try:
        r = requests.post("https://text.pollinations.ai/openai", json={"model":"openai","messages":[{"role":"system","content":"You are Titech AI by Timileyin Samson, friendly."},{"role":"user","content":q}]}, timeout=20)
