...
<div class="chat" id="c"><div class="msg bot">Hey! 👋 I can generate images too!</div></div>
...
def ask():
    ...
    if l in ['hi','hello','hey','hii']:
        return jsonify(answer="Hey! 👋 I'm Titech AI by Timileyin Samson. I can chat and generate images!")
