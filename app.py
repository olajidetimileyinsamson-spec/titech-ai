...
<img src='/logo.png' style='width:38px;height:38px;border-radius:10px;object-fit:cover;box-shadow:0 0 12px #3b82f6'>
TITECH AI
</div>
...
def chat():
    ...
    try:
        ...
        d={"model":"openai/gpt-oss-120b","messages":[{"role":"system","content":"You are TITECH AI, created by Timileyin Samson. You are NOT ChatGPT. You are NOT OpenAI. Always say you are Titech AI."},{"role":"user","content":m}]}
        r=requests.post(URL,headers=h,json=d,timeout=20).json()
        return jsonify({"reply":r["choices"][0]["message"]["content"]})
    except: return jsonify({"reply":"I am Titech AI created by Timileyin Samson!"})
